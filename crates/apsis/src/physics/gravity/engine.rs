...
///
/// `Avx2` is only chosen when both conditions hold:
...
/// - the host CPU advertises AVX2 + FMA via runtime detection.
///
/// The accepted-node phase remains scalar in both branches: vectorising
