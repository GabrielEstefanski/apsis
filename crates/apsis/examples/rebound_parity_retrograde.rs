...
//! — is specified in
//! [`paper/notebooks/2026-05-01-rebound-parity-retrograde.md`](../../../../paper/notebooks/2026-05-01-rebound-parity-retrograde.md).
//!
...
fn main() {
    ...
    writeln!(w, "# protocol: paper/notebooks/2026-05-01-rebound-parity-retrograde.md").unwrap();
