            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                        ...
                        .changed()
                    {
                        ...
                        self.save_modal_entries = gravity_sim_core::io::snapshot::list_saves(
                ...
                if let Some(snap) = &self.pending_load {
                    ...
                    ui.horizontal(|ui| {
                            ...
                            .clicked()
                        {
                            ...
                            self.sim_seed = if snap.seed != 0 { snap.seed } else { gravity_sim_core::io::snapshot::SimSnapshot::new_seed() };
                            self.paused = true;
