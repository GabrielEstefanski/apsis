...
pub struct SimulationApp {
    ...
    pub(super) orbit_hierarchy: gravity_sim_core::physics::orbit_hierarchy::OrbitHierarchy,
    ...
    /// [`gravity_sim_core::core::log`]. Attached to the bus at app construction;
    ...
    pub(super) trail_recorder: gravity_sim_core::core::trail::TrailRecorder,
    ...
    pub(super) field_registry: gravity_sim_core::domain::field::FieldRegistry,
...
impl SimulationApp {
    ...
    pub fn new(system: System) -> Self {
        ...
        Self {
            ...
            orbit_hierarchy: gravity_sim_core::physics::orbit_hierarchy::OrbitHierarchy::new(),
            ...
            trail_recorder: gravity_sim_core::core::trail::TrailRecorder::new(),
            ...
            field_registry: gravity_sim_core::domain::field::FieldRegistry::standard(),
    ...
    fn draw_frame(&mut self, ui: &mut egui::Ui) {
        ...
        let (should_advance, rate) = {
            use gravity_sim_core::core::precision_run::RunState;
            let ctrl = self.system.precision_controller();
            let guard = ctrl.lock().unwrap();
            match guard.state() {
                RunState::Running { .. }
        ...
        let integrator_is_precision = self.physics_cfg.integrator.execution_profile()
            == gravity_sim_core::physics::integrator::traits::ExecutionProfile::Precision;
        let run_in_flight = {
            let ctrl = self.system.precision_controller();
            let guard = ctrl.lock().unwrap();
            !matches!(
