//! Consumer-side store for [`crate::core::log`] events — powers
...
use crate::core::log::{Event, Level};
...
pub fn attach_to_bus(store: Arc<Mutex<NotificationStore>>) -> crate::core::log::SubscriptionId {
    crate::core::log::subscribe(move |event: &Event| {
