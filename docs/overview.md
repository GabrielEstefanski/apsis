...
- Operator-published perturbations: post-Newtonian corrections
  ...
  ([`apsis-central`](../crates/apsis-central/), Tamayo 2020).
...
| [`apsis-central`](../crates/apsis-central/) | Central-potential perturbations (Tamayo 2020, observable-inversion exemplar). |
